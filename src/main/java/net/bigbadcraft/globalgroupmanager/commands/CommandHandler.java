...
public class CommandHandler implements CommandExecutor {
	...
	private void loadCommands() {
		...
		commands.put("addgperm", new AddGroupPerm());
		commands.put("removegperm", new RemoveGroupPerm());
	...
	private void loadCmdSyntaxes() {
		...
		command_syntaxes.add(Syntax.ADD_PERM_GROUP);
		command_syntaxes.add(Syntax.REMOVE_PERM_GROUP);
