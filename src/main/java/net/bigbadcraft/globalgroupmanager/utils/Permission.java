...
public class Permission {
	...
	//public static final String LIST_PERM_USER = "globalgroupmanager.listpermission.user";
	//public static final String LIST_PERM_GROUP = "globalgroupmanager.listpermission.group";
