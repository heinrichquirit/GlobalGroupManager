...
public class Syntax {
	...
	public static final String ADD_PERM_GROUP = "/ggm addgperm <group> <permission>";
	public static final String REMOVE_PERM_GROUP = "/ggm removegperm <group> <permission>";
	public static final String VERSION = "/ggm version";
	//public static final String LIST_PERM_USER = "/ggm listperm user <user>";
	//public static final String LIST_PERM_GROUP = "/ggm listperm group <group>";
